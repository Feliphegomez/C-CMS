...
MV.api = {
	readList(urlIn=null, paramsIn=null, callback=null){
		urlIn = urlIn !== null ? '/records' + ((urlIn[0] !== '/') ? '/' + urlIn  : urlIn) : '/openapi';
		callback = callback !== null ? callback : function(e){};
		paramsIn = paramsIn !== null ? paramsIn : {};
		
		MV.apiFG.get('/api.php' + urlIn, { params: paramsIn})
		.then(function (c){ if(c.status == 200){ callback(c.data.records); } else { return callback([]); } })
		.catch(function (e) {
			console.error(e);
	...
	readSingle(urlIn=null, id=0, paramsIn=null, callback=null){
		urlIn = urlIn !== null ? '/records' + ((urlIn[0] !== '/') ? '/' + urlIn + '/' + id : urlIn) : '/openapi';
		callback = callback !== null ? callback : function(e){};
		paramsIn = paramsIn !== null ? paramsIn : {};
