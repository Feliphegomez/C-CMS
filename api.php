...
namespace Tqdev\PhpCrudApi {
    ...
    $config = new Config([
		...
		// "charset"   => DB_charset,
		'port' => '3306',
		'openApiBase' => '{"info":{"title":"API-REST-MVLTDA","version":"1.0.0"}}',
		'controllers' => 'records,columns,openapi,geojson', //cache
		'middlewares' => 'cors,dbAuth,authorization,sanitation,validation,multiTenancy,customization', //xsrf jwtAuth ipAddress pageLimits
		'cacheType' => 'NoCache',
