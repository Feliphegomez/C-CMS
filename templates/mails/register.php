...
<html lang="en">
<head>
<title>Comunicaciones Oficiales</title>
<meta charset="utf-8">
                                            ...
                                            <tr>
                                                <td align="right" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;">
													<span style="color: #666666; text-decoration: none;">
														Servicios Ambientales y Forestales<br>Monteverde LTDA
													</span>
												</td>
                                            </tr>
                                        </table>
                                                          ...
                                                          <tr>
                                                              <td>
                                                                  <a href="#" target="_blank">
																	<img src="https://micuenta.monteverdeltda.com/templates/mails/images/monteverde-operarios-600x350.png" width="500px" height="auto" border="0" alt="Can an email really be responsive?" style="display: block; padding: 0; color: #666666; text-decoration: none; font-family: Helvetica, arial, sans-serif; font-size: 16px; width: 500px; height: auto;" class="img-max" />
																</a>
                                                              </td>
                                                            </tr>
                                                        </table>
                        ...
                        <table width="500" border="0" cellspacing="0" cellpadding="0" align="center" class="responsive-table">
                            <tr>
                                <td align="center" valign="middle" style="font-size: 12px; line-height: 18px; font-family: Helvetica, Arial, sans-serif; color:#666666;">
									...
									<hr>
									<p class="original-only" style="color: #666666; text-decoration: none;">
										Servicios Ambientales y Forestales<br>Monteverde LTDA
									</p>
									<!-- // 
