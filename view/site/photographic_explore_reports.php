																																				...
																																				foreach($photos as $indexPhoto=>$photo){
																																					...
																																					if($continue7 == true){
																																						...
																																						if($hidenames === false){
																																							echo "<li>
																																								<span>
																																									<a data-style-active=\"text\" style=\"cursor:pointer;\" class=\"linkToImg\" data-file_name=\"{$photo}\" data-path_short=\"/public/reports-photographics/{$year}/{$period_name}/{$group_name}/{$microroute_name}/{$type_name}/{$status_name}/{$photo}\">
