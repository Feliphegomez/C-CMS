	  ...
	  <div class="row">
		<div class="col-sm-8">
		  <div class="img-container">
			<img id="image" src="/public/assets/images/cropper.jpg" alt="Picture">
		  </div>
		</div>
		<div class="col-sm-4">
			<h3>Foto Anterior</h3>
			<div class="docs-preview clearfix">
				<div class="preview-lg">
					<img width="100%" src="https://micuenta.monteverdeltda.com/public/assets/images/cropper.jpg" style="" />
				</div>
