...
<div class="row">
	<div class="col-md-3 col-sm-3 col-xs-3">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content profile_left">
					<div class="profile_img">
						<div id="crop-avatar">
							<img width="100%" class="img-circle img-responsive avatar-view" src="/public/assets/images/picture.jpg" alt="Avatar" title="Change the avatar">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Habilidades <small>Skills</small></h2>
					<ul class="nav navbar-right panel_toolbox">
						<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
						<li class="dropdown">
	...
	<div class="col-md-9 col-sm-9 col-xs-9">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="x_title">
					<h2>Ultimos Archivos <small>Last Media</small></h2>
					<ul class="nav navbar-right panel_toolbox">
						<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-wrench"></i></a>
					  ...
					  <div class="col-md-55">
						<div class="thumbnail">
						  <div class="image view view-first">
							<img style="width: 100%; display: block;" src="/public/assets/images/media.jpg" alt="image" />
							<div class="mask">
							  <p>Your Text</p>
