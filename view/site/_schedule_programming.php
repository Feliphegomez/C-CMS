	...
	<div>
		<div id='wrap'>
			...
			<div >
				<div class="x_panel">
					<div class="x_title">
						<h2>Programacion Periodica <small></small></h2>
			...
			<div :class="'col-md-12 col-sm-12 col-xs-12 ' + ((inSchedule !== false) ? '' : 'hidden')">
				...
				<div class="col-md-3 col-xs-4">
					<div class="x_panel">
						<div class="x_content">
							<div>
								<h4>Microrutas (Arrastrar)</h4>
								<form class="form" v-on:submit="filterList" method="POST" action="javascript:return false;">
									<div class="col-md-12 col-sm-12 col-xs-12 form-group ">
									  <div class="input-group">
										<input v-model="inputSearch" type="text" class="form-control" placeholder="Buscar...">
										<span class="input-group-btn">
										  <button @click="filterList" class="btn btn-default" type="button"><i class="fa fa-search"></i></button>
										</span>
									  </div>
									</div>
								</form>
									<p>
										...
										<label for='drop-remove'>Quitar al colocar</label>
									</p>
								<hr>
								<div class="col-md-12 col-sm-12 col-xs-12 " id='external-events' style="max-height:calc(85vh); overflow: auto;width:100%;">
		...
		filterList(){
			...
			if(self.inputSearch.length > 3){
				...
				$(".fc-event").each(function(){
					...
					if(text.toUpperCase().indexOf(self.inputSearch.toUpperCase()) > -1){
						console.log(text);
			...
			self.options.photographic_groups.forEach(function(a){
				...
				$('#calendar-group-' + a.id).fullCalendar({
					...
					eventClick:  function(event, jsEvent, view) {
						...
						$('#modalBody').html(JSON.stringify(event));
					...
					dayClick: function (date, allDay, jsEvent, view) {
						...
						// Listar microroutes y lo programado
		...
		loadMicroroutes(){
			...
			self.$root.loadAPI_List('emvarias_microroutes', {
				...
				e.forEach(function(a){
					...
					$newdiv1.html(a.name + '<a onclick="javascript: $(\'#calendarModal\').modal();"><i class="fa fa-link"></i></a>');
